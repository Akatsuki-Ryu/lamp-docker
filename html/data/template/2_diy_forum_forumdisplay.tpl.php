...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_list.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1726568881, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/default', 'forum/forumdisplay')
...
// if(/^[a-zA-Z0-9\s.,!?'"()-]+$/.test(theform.message.value.trim())) {
// s = '抱歉，您输入的内容中包含非英文字符，请重新输入';
// }
if(s) {
showError(s);
doane();
