...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1726715154, '1', './data/template/2_1_common_header_forum_announcement.tpl.php', './template/default', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1726715154, '1', './data/template/2_1_common_header_forum_announcement.tpl.php', './template/default', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1726715154, '1', './data/template/2_1_common_header_forum_announcement.tpl.php', './template/default', 'common/header_forum_announcement')
;?>
<!DOCTYPE html>
<html>
<head>
