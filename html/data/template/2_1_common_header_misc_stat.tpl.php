...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1726732203, '1', './data/template/2_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1726732203, '1', './data/template/2_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1726732203, '1', './data/template/2_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
;?>
<!DOCTYPE html>
<html>
<head>
