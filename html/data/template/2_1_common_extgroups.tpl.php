...
<li><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $_G['member']['groupid'];?>"><?php echo $_G['group']['grouptitle'];?></a></li><?php if(isset($extgroupids) && is_array($extgroupids)) foreach($extgroupids as $extgid) { ?><li><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $extgid;?>"><?php echo $_G['cache']['usergroups'][$extgid]['grouptitle'];?></a></li>
<?php } ?>
</ul>
