...
0
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_header.htm', 1726766423, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_userabout.htm', 1726766423, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/header_common.htm', 1726766423, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_diy.htm', 1726766423, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_header_personalnv.htm', 1726766423, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
;?>
<?php if(empty($diymode)) { include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<?php if($_G['setting']['homestyle']) { ?><a href="home.php"><?php echo $_G['setting']['navs'][4]['navname'];?></a><?php } else { ?>动态<?php } ?>
</div>
</div>
...
<?php } if($_G['setting']['taskstatus'] && !empty($task) && is_array($task)) { ?>
<div class="bm">
<div class="bm_h cl">
<span class="y">
...
<div class="bm_c">
<ul class="ml mls cl"><?php if(isset($defaultusers) && is_array($defaultusers)) foreach($defaultusers as $key => $value) { ?><li>
...
<?php if($_G['setting']['ranklist']['membershow'] && $showusers) { ?>
<div class="bm">
<div class="bm_h cl">
<span class="y">
...
<div class="bm_c">
<ul class="ml mls cl"><?php if(isset($showusers) && is_array($showusers)) foreach($showusers as $key => $value) { ?><li>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php if($ols[$value['uid']]) { ?>在线<?php } ?>" class="avt">
<?php if($ols[$value['uid']]) { ?><em class="gol"></em><?php } ?><?php echo avatar($value['uid'], 'small');?></a>
<p><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php echo $value['username'];?>"><?php echo $value['username'];?></a></p>
...
<div class="bm_c">
<ul class="ml mls cl"><?php if(isset($newusers) && is_array($newusers)) foreach($newusers as $key => $value) { ?><li>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php if($ols[$value['uid']]) { ?>在线<?php } ?>" class="avt">
<?php if($ols[$value['uid']]) { ?><em class="gol"></em><?php } ?><?php echo avatar($value['uid'], 'small');?></a>
<p><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php echo $value['username'];?>"><?php echo $value['username'];?></a></p>
...
<div class="bm_c">
<ul class="ml mls cl"><?php if(isset($visitorlist) && is_array($visitorlist)) foreach($visitorlist as $key => $value) { ?><li>
...
<div class="bm_c">
<ul class="ml mls cl"><?php if(isset($olfriendlist) && is_array($olfriendlist)) foreach($olfriendlist as $key => $value) { ?><li>
...
<div class="bm_c">
<table cellpadding="2" cellspacing="4"><?php if(isset($birthlist) && is_array($birthlist)) foreach($birthlist as $key => $values) { ?><tr>
<td align="right" valign="top">
<?php if($values[0]['istoday']) { ?>今天<?php } else { ?><?php echo $values[0]['birthmonth'];?>-<?php echo $values[0]['birthday'];?><?php } ?>
</td>
<td style="padding-left:10px;">
<ul><?php if(isset($values) && is_array($values)) foreach($values as $value) { ?><li><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>"><?php echo $value['username'];?></a></li>
<?php } ?>
</ul>
</td>
</tr>
...
<a href="home.php?mod=spacecp&amp;ac=avatar" title="修改头像" id="edit_avt"><?php if($_G['group']['allowavatarupload']) { ?><span id="edit_avt_tar">修改头像</span><?php } ?><?php echo avatar($_G['uid'], 'middle');?></a>
</div>
...
<?php } } else { ?>
<div class="bm bw0"><?php $space_uid = $space['uid'];
$_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space_uid&amp;do=home&amp;view=me\">TA 的近期动态</a>";?><?php include template('home/space_menu'); } if($_GET['view'] == 'all') { ?>
<p class="tbmu">
...
<a id="a_magic_thunder" href="home.php?mod=magic&amp;mid=thunder" onclick="showWindow('magics', this.href, 'get', 0)" style="padding-left: 18px; background: url(<?php echo STATICURL;?>image/magic/thunder.small.gif) no-repeat 0 50%;" class="y"><?php echo $_G['setting']['magics']['thunder'];?></a>
<?php } ?>
<a href="home.php?mod=space&amp;do=home&amp;view=we"<?php echo $gidactives[-1];?>>全部好友</a><?php if(isset($groups) && is_array($groups)) foreach($groups as $key => $value) { ?><span class="pipe">|</span><a href="home.php?mod=space&amp;do=home&amp;view=we&amp;gid=<?php echo $key;?>"<?php echo $gidactives[$key];?>><?php echo $value;?></a><?php } ?>
</p>
...
<ul class="el"><?php if(isset($hotlist) && is_array($hotlist)) foreach($hotlist as $value) { $value = mkfeed($value);?><?php include template('home/space_feed_li'); } ?>
</ul>
<?php } if($list) { if(isset($list) && is_array($list)) foreach($list as $day => $values) { if($_GET['view']!='hot') { ?>
<h4 class="et">
<?php if($day=='yesterday') { ?>昨天<?php } elseif($day=='today') { ?>今天<?php } else { ?><?php echo $day;?><?php } ?>
</h4>
<?php } ?>

<ul class="el"><?php if(isset($values) && is_array($values)) foreach($values as $value) { include template('home/space_feed_li'); } ?>
</ul>
<?php } ?>				
<?php } elseif($feed_users) { ?>
<div class="xld xlda mtm"><?php if(isset($feed_users) && is_array($feed_users)) foreach($feed_users as $day => $users) { ?><h4 class="et">
<?php if($day=='yesterday') { ?>昨天<?php } elseif($day=='today') { ?>今天<?php } else { ?><?php echo $day;?><?php } ?>
</h4><?php if(isset($users) && is_array($users)) foreach($users as $user) { $daylist = $feed_list[$day][$user['uid']];?><?php $morelist = $more_list[$day][$user['uid']];?><dl class="bbda cl">
<dd class="m avt">
<?php if($user['uid']) { ?>
...
<dd class="cl">
<ul class="el"><?php if(isset($daylist) && is_array($daylist)) foreach($daylist as $value) { include template('home/space_feed_li'); } ?>
</ul>
...
<ul class="el"><?php if(isset($morelist) && is_array($morelist)) foreach($morelist as $value) { include template('home/space_feed_li'); } ?>
</ul>
</div>
<?php } ?>
</dd>
...
<ul class="el"><?php if(isset($filter_list) && is_array($filter_list)) foreach($filter_list as $value) { include template('home/space_feed_li'); } ?>
