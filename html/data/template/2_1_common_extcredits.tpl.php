...
<ul class="bbda mbn pbn"><?php if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $extcreditid => $extcredit) { if(empty($extcredit['hiddeninheader'])) { ?>
...
<?php if(($_G['setting']['ec_ratio'] && payment::enable()) || $_G['setting']['card']['open']) { ?>
