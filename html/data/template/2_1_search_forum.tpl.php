...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1726586899, '1', './data/template/2_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1726586899, '1', './data/template/2_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1726586899, '1', './data/template/2_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1726586899, '1', './data/template/2_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1726586899, '1', './data/template/2_1_search_forum.tpl.php', './template/default', 'search/forum')
;?>
<!DOCTYPE html>
<html>
<head>
...
<em>&copy; 2001-2024 <a href="https://code.dismall.com/" target="_blank">Discuz! Team</a>.</em>
...
<?php if($_G['setting']['icp'] || $_G['setting']['mps']) { ?>( <?php if($_G['setting']['icp']) { ?><a href="https://beian.miit.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a><?php } if($_G['setting']['mps']) { if($_G['setting']['icp']) { ?><span class="pipe">|</span><?php } ?><a href="https://beian.mps.gov.cn/#/query/webSearch?code=<?php echo $_G['setting']['mpsid'];?>" target="_blank"><img width="14" height="14" src="<?php echo IMGDIR;?>/ico_mps.png" /><?php echo $_G['setting']['mps'];?></a><?php } ?> )<?php } ?>
