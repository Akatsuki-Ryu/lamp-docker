...
0
|| checktplrefresh('./template/default/forum/stat_memberlist.htm', './template/default/common/stat.htm', 1726851568, '1', './data/template/2_1_forum_stat_memberlist.tpl.php', './template/default', 'forum/stat_memberlist')
...
</tr><?php if(isset($memberlist) && is_array($memberlist)) foreach($memberlist as $member) { ?><tr class="<?php echo swapclass('alt'); ?>">
