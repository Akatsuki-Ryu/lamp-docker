...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1726715384, '1', './data/template/2_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1726715384, '1', './data/template/2_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1726715384, '1', './data/template/2_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
;?>
<!DOCTYPE html>
<html>
<head>
