...
<?php if($_G['setting']['icp'] || !empty($_G['setting']['mps'])) { ?>( <?php if($_G['setting']['icp']) { ?><a href="https://beian.miit.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a><?php } if(!empty($_G['setting']['mps'])) { if($_G['setting']['icp']) { ?><span class="pipe">|</span><?php } ?><a href="https://beian.mps.gov.cn/#/query/webSearch?code=<?php echo $_G['setting']['mpsid'];?>" target="_blank"><img width="14" height="14" src="<?php echo IMGDIR;?>/ico_mps.png" /><?php echo $_G['setting']['mps'];?></a><?php } ?> )<?php } ?>
