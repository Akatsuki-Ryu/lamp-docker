...
<?php if(!empty($_GET['listextra'])) { ?><input type="hidden" name="listextra" value="<?php echo $_GET['listextra'];?>" /><?php } if(!empty($_GET['infloat'])) { ?><input type="hidden" name="handlekey" value="<?php echo $_GET['handlekey'];?>" /><?php } if(isset($threadlist) && is_array($threadlist)) foreach($threadlist as $thread) { ?><input type="hidden" name="moderate[]" value="<?php echo $thread['tid'];?>" />
<?php } ?>
<div class="c">
...
<input onclick="showcalendar(event, this, true)" type="text" autocomplete="off" id="expirationstick" name="expirationstick" class="px" value="<?php echo $expirationstick;?>" />
...
<input onclick="showcalendar(event, this, true)" type="text" name="expirationdigest" id="expirationdigest" class="px" autocomplete="off" value="<?php echo $expirationdigest;?>" />
...
<a href="javascript:;" id="highlight_color_ctrl" onclick="showHighLightColor('highlight_color')" class="pn colorwd"<?php if($colorcheck) { ?> style="background-color: <?php echo $_G['forum_colorarray'][$colorcheck];?>"<?php } ?> /></a>
</span>
...
<input type="text" name="expirationhighlight" id="expirationhighlight" class="px" onclick="showcalendar(event, this, true)" autocomplete="off" value="<?php echo $expirationhighlight;?>" />
...
<input type="button"<?php if($highlight_bgcolor) { ?> style="background-color: <?php echo $highlight_bgcolor;?>"<?php } ?> value="" class="pn colorwd" onclick="createPalette('highlight_bgcolor_ctrl', 'highlight_bgcolor');" id="chighlight_bgcolor_ctrl">
</p>
</td>
</tr>
</table>
...
<input type="text" name="expirationrecommend" id="expirationrecommend" class="px" onclick="showcalendar(event, this, true)" autocomplete="off" value="<?php echo $expirationrecommend;?>" />
...
<input type="text" name="reducetitle" id="reducetitle" class="px" style="width: 122px" value="<?php echo $thread['subject'];?>" />
</td>
</tr>
<?php if($imgattach) { ?>
<tr class="dopt">
...
<option value="">不显示</option><?php if(isset($imgattach) && is_array($imgattach)) foreach($imgattach as $imginfo) { ?><option value="<?php echo $imginfo['aid'];?>"<?php if($selectattach == $imginfo['aid']) { ?> selected="selected"<?php } ?>><?php echo $imginfo['filename'];?></option>
<?php } ?>
</select>
</td>
</tr>
...
var imgk = new Array();<?php if(isset($imgattach) && is_array($imgattach)) foreach($imgattach as $imginfo) { $a = '\"\'\t\\""\\\''."\\\\";$k = getforumimg($imginfo['aid'], 1, 120, 80);?>imgk[<?php echo $imginfo['aid'];?>] = '<?php echo $k;?>';
<?php } ?>
...
<td>
<p class="hasd">
<input type="text" name="expirationclose" id="expirationclose" class="px" onclick="showcalendar(event, this, true)" autocomplete="off" value="<?php echo $expirationclose;?>" />
