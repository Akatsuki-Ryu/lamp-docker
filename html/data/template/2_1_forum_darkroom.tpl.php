...
<?php if($crimelist) { $i = 0;?><?php if(isset($crimelist) && is_array($crimelist)) foreach($crimelist as $crime) { $i++;?><tr id="darkroomuid_<?php echo $crime['uid'];?>" <?php if($i % 2 == 0) { ?> class="alt"<?php } ?>>
<td><a href="home.php?mod=space&amp;uid=<?php echo $crime['uid'];?>" target="_blank"><?php echo $crime['username'];?></a></td>
