...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1726766939, '1', './data/template/2_1_common_header_home_rss.tpl.php', './template/default', 'common/header_home_rss')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1726766939, '1', './data/template/2_1_common_header_home_rss.tpl.php', './template/default', 'common/header_home_rss')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1726766939, '1', './data/template/2_1_common_header_home_rss.tpl.php', './template/default', 'common/header_home_rss')
;?>
<!DOCTYPE html>
<html>
<head>
