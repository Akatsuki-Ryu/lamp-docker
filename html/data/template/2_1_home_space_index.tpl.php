...
<?php } if(isset($leftlist) && is_array($leftlist)) foreach($leftlist as $key => $value) { if(!empty($key)) { ?>
...
<?php } if(isset($centerlist) && is_array($centerlist)) foreach($centerlist as $key => $value) { if(!empty($key)) { ?>
<div id="<?php echo $key;?>" class="block move-span">
<?php echo $value;?>
</div>
<?php } } ?>
...
<?php } if(isset($rightlist) && is_array($rightlist)) foreach($rightlist as $key => $value) { if(!empty($key)) { ?>
<div id="<?php echo $key;?>" class="block move-span">
<?php echo $value;?>
</div>
<?php } } ?>
